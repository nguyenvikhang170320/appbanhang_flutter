...
class _ProfileSellerState extends State<ProfileSeller> {
  ...
  void vaildation() async {
    if (userName.text.isEmpty && phoneNumber.text.isEmpty && shopName.text.isEmpty) {
      ...
      ToastService.showToast(context,
          ...
          expandedHeight: 100,
          message: "Vui lòng nhập tên mới");
    } else if (shopName.text.length < 3) {
      ToastService.showWarningToast(context,
          length: ToastLength.medium,
          expandedHeight: 100,
          message: "Tên quá ngắn");
  ...
  Widget _buildContainerPart() {
    ...
    shopName = TextEditingController(text: userProvider.getShopNameData());
    ...
    return Container(
        ...
        child: Column(
          ...
          children: [
            ...
            _buildSingleProfile(
                name: "Tên Shop: ", value: userProvider.getShopNameData()),
            _buildSingleProfile(
